package com.jun.fakeoschina.widget;
/*
...
//            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // tabsLayout.getMeasuredWidth() 获得的是选项卡的总宽度 （528）
        // getMeasuredWidth() 获得的是pagerSlidingTabStrip 在布局xml中设置的宽度（720） 所以必须是android:layout_width="match_parent"
        if (tabsLayout == null
